...
ActiveRecord::Schema.define(version: 20180224184011) do
  ...
  create_table "direct_message_channel_memberships", force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "last_visited_channel", default: ""
